			...
			<?php foreach ($attributes['teamates'] as $teamate) { ?>
				...
				<div class="col team_item">
					...
					<div>
						...
						<span></span>
						<ul>
							<?php if (isset($teamate['teamate_facebook_link']) && !empty($teamate['teamate_facebook_link'])) { ?>
								<li>
							...
							<?php if (isset($teamate['teamate_instagram_link']) && !empty($teamate['teamate_instagram_link'])) { ?>
								<li>
							...
							<?php if (isset($teamate['teamate_linkedin_link']) && !empty($teamate['teamate_linkedin_link'])) { ?>
								<li>
							...
							<?php if (isset($teamate['teamate_twitter_link']) && !empty($teamate['teamate_twitter_link'])) { ?>
								<li>
