					...
					<div>
						...
						<ul>
							<?php if (isset($inner['link-linkedin']) && !empty($inner['link-linkedin'])) { ?>
								<li>
									<a href="<?= $inner['link-linkedin']; ?>" target="_blank" rel="nofollow">
										...
										<?= $inner['account-name-of-linkedin']; ?>
									</a>
								</li>
							<?php } ?>
							...
							<?php if (isset($inner['link-twitter']) && !empty($inner['link-twitter'])) { ?>
								<li>
									<a href="<?= $inner['link-twitter']; ?>" target="_blank" rel="nofollow">
							...
							<?php if (isset($inner['link-instagram']) && !empty($inner['link-instagram'])) { ?>
								<li>
									<a href="<?= $inner['link-instagram']; ?>" target="_blank" rel="nofollow">
										...
										<?= $inner['account-name-of-instagram']; ?>
									</a>
								</li>
							<?php } ?>
							...
							<?php if (isset($inner['link-facebook']) && !empty($inner['link-facebook'])) { ?>
								<li>
									<a href="<?= $inner['link-facebook']; ?>" target="_blank" rel="nofollow">
										...
										<?= $inner['account-name-of-facebook']; ?>
									</a>
								</li>
							<?php } ?>
						</ul>
