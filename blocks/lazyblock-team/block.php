        ...
        <div class="col-3 team">
			...
			<?php foreach ($attributes['repeater'] as $inner) { ?>
				...
				<div class="col team_item">
                    ...
                    <?php endif; ?>
					<div>
						<p><?php echo $inner['job']; ?></p>
						<h3><?php echo $inner['name']; ?></h3>
						<p><?php echo $inner['description']; ?></p>
						<span></span>
						<ul>
							<?php if (isset($inner['link-linkedin']) && !empty($inner['link-linkedin'])) { ?>
								<li>
									<a href="<?php echo $inner['link-linkedin']; ?>" target="_blank" rel="nofollow">
										...
										<?php echo $inner['account-name-of-linkedin']; ?>
									</a>
								</li>
							<?php } ?>
							...
							<?php if (isset($inner['link-twitter']) && !empty($inner['link-twitter'])) { ?>
								<li>
									<a href="<?php echo $inner['link-twitter']; ?>" target="_blank" rel="nofollow">
										...
										<?php echo $inner['account-name-of-twitter']; ?>
									</a>
								</li>
							<?php } ?>
							...
							<?php if (isset($inner['link-instagram']) && !empty($inner['link-instagram'])) { ?>
								<li>
									<a href="<?php echo $inner['link-instagram']; ?>" target="_blank" rel="nofollow">
										...
										<?php echo $inner['account-name-of-instagram']; ?>
									</a>
								</li>
							<?php } ?>
							...
							<?php if (isset($inner['link-facebook']) && !empty($inner['link-facebook'])) { ?>
								<li>
									<a href="<?php echo $inner['link-facebook']; ?>" target="_blank" rel="nofollow">
										...
										<?php echo $inner['account-name-of-facebook']; ?>
									</a>
								</li>
							<?php } ?>
						</ul>
