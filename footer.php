            ...
            <div class="container footer_container">
                ...
                <ul class="footer_social">
                    <?php if(get_theme_mod('neptune_social_linkedin')) :?>
                        <li>
                            <a href="<?php echo esc_url(get_theme_mod('neptune_social_linkedin')); ?>" target="_blank" rel="nofollow">
                    ...
                    <li>
                        <a href="<?php echo esc_url(get_theme_mod('neptune_social_twitter')); ?>" target="_blank" rel="nofollow">
                    ...
                    <li>
                        <a href="<?php echo esc_url(get_theme_mod('neptune_social_instagram')); ?>" target="_blank" rel="nofollow">
                    ...
                    <?php if(get_theme_mod('neptune_social_facebook')) :?>
                        <li>
                            <a href="<?php echo esc_url(get_theme_mod('neptune_social_facebook')); ?>" target="_blank" rel="nofollow">
